...
m_R <- mongo("messages_R", url = "mongodb://cparra:i.}4rF-e(-mUE@127.0.0.1:27017/bdd_grp4?authSource=admin")

wordcloud_R <- function() {

#Construction de la df s'appuyant sur la key body
text <- m_R$aggregate('[{"$project": {"_id":0,"body":"$body"}}]')
...
result_W_R <- wordcloud_R()

set.seed(1234) # for reproducibility 
wordcloud2a(data=result_W_R, size=0.5, color='random-dark')
